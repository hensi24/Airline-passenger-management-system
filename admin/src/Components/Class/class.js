...
import { CLasscardprops } from "./classcardprops";
...
export const Class = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/airlinesclass/view")
      .then((res) => {
  ...
  const delhandel = (e) => {
    console.log(e);
    axios
      .delete(`http://localhost:3000/airlinesclass/delete/${e}`)
      .then((res) => {
  ...
  const togglePopup = (e) => {
    ...
    setShowPopup(!showPopup);
    axios
      .get(`http://localhost:3000/airlinesclass/show/${e}`)
      .then((res) => {
                          ...
                          <Formik
                            ...
                            onSubmit={async (values) => {
                              if (getempid) {
                                axios
                                  .put(
                                    `http://localhost:3000/airlinesclass/update/${getempid}`,
                                    values
                                  )
                                  .then((res) => {
                                    console.log(res);
                                ...
                                axios
                                  .post(
                                    "http://localhost:3000/airlinesclass/add",
                                    values
                                  )
                                  .then((res) => {
                                    console.log(res);
