...
import { Airlinescardprops } from "./airlinescardprops";
...
export const Airlines = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/airline/view")
      .then((res) => {
  ...
  const delhandel = (e) => {
    console.log(e);
    axios
      .delete(`http://localhost:3000/airline/delete/${e}`)
      .then((res) => {
  ...
  const togglePopup = (e) => {
    ...
    setShowPopup(!showPopup);
    axios
      .get(`http://localhost:3000/airline/show/${e}`)
      .then((res) => {
                          ...
                          <Formik
                            ...
                            onSubmit={async (values) => {
                              if (getempid) {
                                axios
                                  .put(
                                    `http://localhost:3000/airline/update/${getempid}`,
                                    values
                                  )
                                  .then((res) => {
                                    console.log(res);
                                ...
                                axios
                                  .post(
                                    "http://localhost:3000/airline/add",
                                    values
                                  )
                                  .then((res) => {
                                    console.log(res);
