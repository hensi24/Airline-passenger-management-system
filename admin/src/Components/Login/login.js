                ...
                <div className="login-form form-wraper">
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      axios
                        .post("http://localhost:3000/admin_login/login", values)
                        .then((res) => {
                          console.log(res);
                ...
                <div className="signUp-form form-wraper">
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      // );
                      axios
                        .post("http://localhost:3000/admin_login/add", formData)
                        .then((res) => {
                          console.log(res);
                          notify(res.data.status);
                          resetForm();
                      ...
                      //     "http://localhost:3000/admin_login/add",
                      //     formData
                      //   );
                      ...
                      //   );
                      //   notify("Error occurred during sign-up", "error");
                      // }
                    }}
                  >
                    <Form>
